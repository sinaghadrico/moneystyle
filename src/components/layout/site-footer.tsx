...
export function SiteFooter({ maxWidth = "max-w-3xl" }: { maxWidth?: string }) {
  return (
      ...
      <div className={`mx-auto ${maxWidth} px-4 py-6`}>
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between text-sm text-muted-foreground">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <span>&copy; {new Date().getFullYear()} MoneyStyle</span>
            {NAV_LINKS.map((link) => (
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="https://instagram.com/moneystyleapp"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-foreground transition-colors"
            ...
            <a
              href="https://t.me/moneystyle_app"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-foreground transition-colors"
              aria-label="Telegram"
